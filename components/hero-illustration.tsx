...
export function HeroIllustration() {
    ...
    return (
        <div className="relative w-full max-w-[800px] mx-auto overflow-hidden bg-gradient-to-br from-black/40 to-black/10 backdrop-blur-lg rounded-2xl">
            {/* Background Accents */}
            <div className="absolute -top-40 -right-40 w-80 h-80 bg-[#CE035F] rounded-full blur-[100px] opacity-20"></div>
            <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-[#CE035F] rounded-full blur-[100px] opacity-10"></div>
            ...
            <div className="relative flex flex-col items-center p-8">
                ...
                <div className="w-full flex flex-col items-center gap-10">
                        ...
                        <div className="flex flex-col gap-4 p-4 md:p-6 border-2 border-[#CE035F]/30 rounded-2xl bg-black/5 backdrop-blur-sm shadow-[0_0_15px_rgba(206,3,95,0.1)]">
                            <div className="bg-black/20 backdrop-blur-sm rounded-2xl p-4 md:p-6">
                                <div className="flex items-center justify-center gap-4 mb-6">
                                    ...
                                    <h3 className="text-lg font-medium text-white">{t.orderConfirmation}</h3>
                                </div>

                                {/* Platform Integration */}
                                <div className="flex items-center justify-center gap-6">
                                    <div className="w-12 h-12 bg-[#CE035F]/10 rounded-lg flex items-center justify-center">
                                        <FaShopify className="w-6 h-6 text-[#CE035F]" />
                                    </div>
                                    <div className="w-12 h-12 bg-[#CE035F]/10 rounded-lg flex items-center justify-center">
                                        <SiWoocommerce className="w-6 h-6 text-[#CE035F]" />
                                    </div>
                                    <div className="w-12 h-12 bg-[#CE035F]/10 rounded-lg flex items-center justify-center">
                                        <FaWordpress className="w-6 h-6 text-[#CE035F]" />
                                    </div>
                                </div>
                            </div>
                            <div className="px-3 py-1.5 bg-[#CE035F]/10 backdrop-blur-sm rounded-lg flex items-center gap-2 justify-center">
                                <div className="w-2 h-2 rounded-full bg-[#CE035F] animate-pulse"></div>
                        ...
                        <div className="flex flex-col gap-4 p-4 md:p-6 border-2 border-[#CE035F]/30 rounded-2xl bg-black/5 backdrop-blur-sm shadow-[0_0_15px_rgba(206,3,95,0.1)]">
                            <div className="bg-black/20 backdrop-blur-sm rounded-2xl p-4 md:p-6">
                                <div className="flex items-center justify-center gap-4 mb-6">
                                    ...
                                    <h3 className="text-lg font-medium text-white">{t.shippingValidation}</h3>
                                </div>

                                {/* Validation Steps */}
                                <div className="flex items-center justify-center gap-6">
                                    <div className="w-12 h-12 bg-[#CE035F]/10 rounded-lg flex items-center justify-center">
                                        <TbTruckDelivery className="w-6 h-6 text-[#CE035F]" />
                                    </div>
                                    <div className="w-12 h-12 bg-[#CE035F]/10 rounded-lg flex items-center justify-center">
                                        <Package className="w-6 h-6 text-[#CE035F]" />
                                    </div>
                                    <div className="w-12 h-12 bg-[#CE035F]/10 rounded-lg flex items-center justify-center">
                                        <BellRing className="w-6 h-6 text-[#CE035F]" />
                                    </div>
                                </div>
                            </div>
                            <div className="px-3 py-1.5 bg-[#CE035F]/10 backdrop-blur-sm rounded-lg flex items-center gap-2 justify-center">
                    ...
                    <div className="w-full flex items-center justify-center gap-4 px-8">
                        <div className="h-px flex-1 bg-gradient-to-r from-transparent via-[#CE035F]/30 to-transparent"></div>
                        <div className="px-4 py-2 bg-black/20 backdrop-blur-sm rounded-lg flex items-center gap-2">
                            <RefreshCcw className="w-3 h-3 text-[#CE035F] animate-spin" />
                    ...
                    <div className="w-full p-6 border-2 border-[#CE035F]/30 rounded-2xl bg-black/5 backdrop-blur-sm shadow-[0_0_15px_rgba(206,3,95,0.1)]">
                        <div className="w-full bg-black/20 backdrop-blur-sm rounded-2xl p-6">
                            <div className="grid grid-cols-4 gap-8">
                                <div className="relative">
                                    <div className="absolute top-1/2 -right-3 w-full h-0.5 bg-gradient-to-r from-[#CE035F]/50 to-[#CE035F]/10"></div>
                                    <div className="flex flex-col items-center gap-3 group">
                                        <div className="w-14 h-14 bg-[#CE035F]/10 rounded-xl flex items-center justify-center group-hover:bg-[#CE035F]/20 transition-all">
                                            <Phone className="w-7 h-7 text-[#CE035F]" />
                                        </div>
                                ...
                                <div className="relative">
                                    ...
                                    <div className="flex flex-col items-center gap-3 group">
                                        <div className="w-14 h-14 bg-[#CE035F]/10 rounded-xl flex items-center justify-center group-hover:bg-[#CE035F]/20 transition-all">
                                            <FaWhatsapp className="w-7 h-7 text-[#CE035F]" />
                                        </div>
                                        <div className="text-center">
                                ...
                                <div className="relative">
                                    ...
                                    <div className="flex flex-col items-center gap-3 group">
                                        <div className="w-14 h-14 bg-[#CE035F]/10 rounded-xl flex items-center justify-center group-hover:bg-[#CE035F]/20 transition-all">
                                            <MessageSquare className="w-7 h-7 text-[#CE035F]" />
                                        </div>
                                        <div className="text-center">
                                ...
                                <div className="flex flex-col items-center gap-3 group">
                                    <div className="w-14 h-14 bg-[#CE035F]/10 rounded-xl flex items-center justify-center group-hover:bg-[#CE035F]/20 transition-all">
                                        <Mail className="w-7 h-7 text-[#CE035F]" />
                                    </div>
                                    <div className="text-center">

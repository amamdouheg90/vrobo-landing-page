      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Vrobo helps e-commerce businesses reduce failed deliveries through AI-Powered Order Confirmation and shipping verification.",
            "sameAs": [
            ...
            "mainEntity": [
              {
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Vrobo offers two main services: 1) Order Validation - verifying orders with customers before shipping through AI-powered calls, WhatsApp, SMS, and email, and 2) Shipping Verification - checking shipping companies' reports when orders are marked as undelivered to detect fake updates."
                }
              },
              {
                "@type": "Question",

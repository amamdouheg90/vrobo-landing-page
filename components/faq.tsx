...
const translations = {
  ...
  ar: {
    ...
    subtitle: "إجابات على الأسئلة المتكررة عن ڤي روبو",
    faqs: [
      {
        question: "إيه هي خدمات ڤي روبو الرئيسية؟",
        answer:
          "ڤي روبو بيقدم خدمتين رئيسيين: 1) التحقق من الطلبات - بنتأكد من الطلبات مع العملاء قبل الشحن عن طريق المكالمات الذكية والواتساب والرسايل والإيميل، و 2) التحقق من الشحن - بنتأكد من تقارير شركات الشحن لما الطلبات تتبلغ كمرفوضة.",
      },
      {
        question: "إزاي بيشتغل نظام التواصل بتاع ڤي روبو؟",
        answer:
          "ڤي روبو بيتبع نظام تواصل ذكي: الأول، بيعمل لحد 3 محاولات مكالمات ذكية برسايل مخصصة لعلامتك التجارية. لو المكالمات مانجحتش، بينتقل لمحادثات واتساب مع تحليل ذكي للردود. لو الواتساب مانجحش، بيبعت رسايل قصيرة. وأخيراً، بيبعت إيميل عشان نضمن أعلى نسبة وصول.",
      },
      {
        question: "إزاي ڤي روبو بيتكامل مع منصات التجارة الإلكترونية؟",
        answer:
          "ڤي روبو بيتكامل بسهولة مع المنصات الكبيرة زي شوبيفاي وووكومرس. لما حالة الطلب تتغير أو معلومات العميل تتحدث، ڤي روبو بيزامن البيانات دي تلقائياً مع منصتك وبيبلغ شركات الشحن في نفس اللحظة.",
      },
      {
        question: "إزاي ڤي روبو بيتعامل مع التحقق من الشحن؟",
        answer:
          "لما شركة الشحن تبلغ عن فشل توصيل، ڤي روبو بيتواصل تلقائياً مع العميل من خلال قنوات متعددة عشان يتأكد إذا كان البلاغ حقيقي. ده بيساعد في منع تقارير حالة التوصيل المزيفة وبيضمن تتبع دقيق للطلبات.",
      },
      {
        question: "بيحصل إيه لما ڤي روبو يكتشف تحديثات شحن مزيفة؟",
        answer:
          "لما ڤي روبو يلاقي اختلاف بين تقرير شركة الشحن ورد العميل، بيبلغ التاجر وشركة الشحن على طول. وبيحدث حالة الطلب في منصة التجارة الإلكترونية بالمعلومات الصحيحة.",
      },
      {
        question: "ڤي روبو ممكن يحدث معلومات الاتصال بالعملاء؟",
        answer:
          "أيوة، لما ڤي روبو بيتواصل مع العملاء، بيقدر يجمع معلومات الاتصال المحدثة أو تفضيلات التوصيل. المعلومات دي بتتزامن تلقائياً مع منصة التجارة الإلكترونية وبتتشارك مع شركات الشحن عشان نمنع مشاكل التوصيل في المستقبل.",
      },
      {
        question: "إيه نظام تسعير ڤي روبو؟",
        answer:
          "ڤي روبو بيقدم أسعار حسب حجم الطلبات الشهرية، بتبدأ من 3 جنيه للطلب للتجار اللي عندهم أقل من 2,000 طلب شهرياً، وبتوصل لـ 1.5 جنيه للطلب للي عندهم أكتر من 20,000 طلب شهرياً. كل الباقات بتشمل خدمتي التحقق وكل قنوات التواصل.",
      },
    ],
  },
}
